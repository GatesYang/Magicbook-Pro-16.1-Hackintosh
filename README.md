...
### 更新预告 
* 1.更新所有驱动程序
* 2.有朋友私信我锐龙版的能不能安装，我暂时没有实机进行测试，理论上除了CPU和显卡硬件差别不太大
...
* 5.升级Clover至v5100（ Clover的升级日志说5098对10.15做了优化，我们的v1.5版刚好是5097）
* 6.电池管理替换成更好的SMCBatteryManager
* 7.添加“文件保险箱”功能所需驱动（有待测试）
* 8.此次更新部分代码参考了@hjmmc的成熟代码，在此表示感谢！
* 9.更新所有驱动程序（AppleALC，Virtual SMC等）
